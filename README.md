# Saigon Steps - Staff Dashboard

This is the Staff Dashboard portion of our University Graduation project. Built with ReactJS, Typescript and Shadcn-UI.
...
You can view the app by visiting `http://localhost:4000` in your browser.
