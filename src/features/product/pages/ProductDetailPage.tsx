    ...
    if (!getProductDetailQuery.isPending && !product) {
        return (
            <div className="flex h-full flex-col items-center justify-center gap-2">
                ...
                <p className="mt-2 font-semibold">Không tìm thấy sản phẩm với chuỗi slug là: {slug?.toString()}</p>
            ...
            <div className="flex items-center justify-between space-y-2">
                <div>
                    ...
                    <p className="text-muted-foreground">
                        Đây là thông tin chi tiết về sản phẩm "{product!.name}" với mã sản phẩm {product!.rootProductId}
                        .
                    </p>
                </div>
